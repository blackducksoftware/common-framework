...
public class TemplateColumn {
	...
	// This is an optional value that is set by the ConfigManager via poperty file mappings
	...
	/**
	 * This denotes what kind of cell this is.  Numbe, string, etc?  Useful for formatting.
	 */
	 ...
	 * Sets the column pos.
	 *
	 * @param columnPos the new column pos
	 */
	 ...
	 * Sets the column url.
	 *
	 * @param isColumnURL the new column url
	 */
	 ...
	 *
	 * @param lookupMappingName the new lookup mapping name
	 */
