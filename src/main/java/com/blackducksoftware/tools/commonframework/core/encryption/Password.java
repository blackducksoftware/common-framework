...
public class Password {
     ...
     */
    public static String encryptEncode(String password)
	...
	byte[] encryptedPasswordAscii = Ascii85Encoder
     ...
     */
    public static String decodeDecrypt(String encryptedPassword)
	...
	byte[] encryptedPasswordAsciiBytes = encryptedPassword.getBytes(UTF8); // convert
									       // from
									       // String
									       // to
									       // byte
     ...
     * @throws NoSuchAlgorithmException
     */
    private static byte[] encrypt(Key keyToUse, String password)
	    throws IllegalBlockSizeException, BadPaddingException,
	    InvalidKeyException, NoSuchAlgorithmException,
     ...
     * @throws CertificateException
     */
    private static Key getKey(char[] keypass) throws KeyStoreException,
	    NoSuchAlgorithmException, CertificateException, IOException,
     ...
     * @throws CertificateException
     */
    private static Key getKeyFromStore(String keyStoreFilename, char[] keypass)
	    throws IOException, UnrecoverableKeyException, KeyStoreException,
	    NoSuchAlgorithmException, CertificateException {
	InputStream keyStoreInputStream = thisClass
