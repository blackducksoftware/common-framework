...
public class QueryBuilder {
	...
	public static String COLUMN_CURRENT_TIME = "currentTime";
	...
	public static Map<String, String> QUERY_LIST = new HashMap<String, String>();
	 ...
	 * @param interval the interval to check for records
	 * @return the criteria for interval calculation
	 */
	public static String getQueryIntervalWithTimeZone(int interval, String name){
	 ...
	 */
	public static String getQueryDatabaseCurrentTime() throws SQLException {
	 ...
	 * @param dateCriteria the criteria for the date
	 * @return the query to retrieve all new vulnerabilities for the provided date
	 */
	public static String getQueryVulnerabilityNew(String dateCriteria){
		StringBuilder stringBuilder = new StringBuilder();
		...
		stringBuilder.append(" AND nvd_cve_id IS NOT NULL AND nvd_entry_type_code = ");
	...
	/**
	 * Build the query to retrieve all updated vulnerabilities for the provided date
	 * @param dateCriteria the criteria for the date
	 * @return the query to retrieve all updated vulnerabilities for the provided date
	 */
	public static String getQueryVulnerabilityUpdated(String dateCriteria){
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(QueryBuilder.getQueryString(QueryBuilder.VULNERABILITIES));
		stringBuilder.append(" WHERE nvd_cve_id IN ");
		stringBuilder.append(" (SELECT nvd_cve_id FROM nvd_update_log WHERE "); 
		stringBuilder.append(dateCriteria);
	...
	/**
	 * Build the query to retrieve the vulnerability impact information for the provided date
	 * @param dateCriteria the criteria for the date
	 * @return the query to retrieve the vulnerability impact information for the provided date
	 */
	public static String getQueryVulnerabilityImpact(String dateCriteria){
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append("SELECT log.nvd_cve_id, mappings.nvd_cve_version_id, mappings.release_id ");
		stringBuilder.append(" FROM nvd_release_mappings mappings, nvd_update_log log ");
		stringBuilder.append(" WHERE mappings.nvd_cve_version_id = log.nvd_cve_version_id ");
	...
	/**
	 * Build the query to retrieve the component list for the provided release id
	 * @param releaseId the component release id 
	 * @return the query to retrieve the component list for the provided release id
	 */
	public static String getQueryComponentForRelease(int releaseId){	
		StringBuilder stringBuilder = new StringBuilder();
	...
	/**
	 * Build the query to retrieve the component information from the COMPONENTUSE table
	 * @param componentId the component id 
	 * @return the query to retrieve the component information for the component id 
	 */
	public static String getQueryComponentFromComponentUse(String componentId){
		StringBuilder stringBuilder = new StringBuilder();
	...
	/**
	 * Build the query to retrieve the application information for the provided application id
	 * @param componentId the application id 
	 * @return the query to retrieve the application information for the application id 
	 */
	public static String getQueryAppliaction(String applicationId){
		StringBuilder stringBuilder = new StringBuilder();
	...
	/**
	 * Build the query to retrieve the vulnerability information for the provided id
	 * @param nvdCveId the vulnerability id 
	 * @return the query to retrieve the vulnerability information for the id 
	 */
	public static String getQueryVulnerabilityById(int nvdCveId){
		StringBuilder stringBuilder = new StringBuilder();
	...
	/**
	 * Logs the query and returns it as a string representing the data in the built sequence  
	 * @param stringBuilder a string builder initialized to the contents of the built query string.
	 * @return the query as a string representing the data in the built sequence
	 */
	private static String logQuery(StringBuilder stringBuilder){
